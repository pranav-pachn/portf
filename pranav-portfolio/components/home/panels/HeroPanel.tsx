      ...
      <Container className="relative z-10">
        <div className="flex flex-col items-center justify-center gap-16 lg:gap-8">
          ...
          <div className="w-full max-w-4xl mx-auto flex flex-col items-center text-center pt-10 lg:pt-0">
            ...
            <AnimatedText 
              as="h1"
              className="text-5xl sm:text-6xl md:text-7xl lg:text-[6rem] font-display font-bold tracking-tight text-text-primary leading-[1.05] mb-8 justify-center"
              delay={0.2}
              segments={[
                { text: 'Building ' },
            ...
            <AnimateOnScroll variant="fade" delay={0.4}>
              <p className="text-xl text-text-secondary max-w-2xl mx-auto mb-12 leading-relaxed font-medium">
                I design polished interfaces, architect backend systems, and integrate AI into production-ready applications.
              </p>
            </AnimateOnScroll>
              ...
              <div className="flex flex-row items-center justify-center gap-8">
                <MagneticButton>
                  <Button 
                    ...
                    className="rounded-full px-10 py-7 shadow-[0_0_20px_rgba(var(--color-accent-500),0.2)] hover:shadow-[0_0_30px_rgba(var(--color-accent-500),0.4)] transition-shadow text-lg" 
