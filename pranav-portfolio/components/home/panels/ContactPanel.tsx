      ...
      <Container narrow className="relative z-10 text-center">
        <AnimateOnScroll variant="scale">
          ...
          <SectionHeading 
            ...
            align="center" 
          />
          <p className="text-text-secondary text-lg mb-12 max-w-xl mx-auto leading-relaxed font-medium">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <div className="flex items-center justify-center gap-4">
              {socialLinks.map(link => {
                // Ensure email is not duplicated if it's in social links
                ...
                return (
                  <Button 
                    ...
                    variant="ghost" 
                    external
                    className="font-bold text-text-secondary hover:text-accent-500 group"
                  >
                    {link.label}
