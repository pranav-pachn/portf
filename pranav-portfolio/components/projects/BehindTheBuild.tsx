...
export function BehindTheBuild({ project, variant }: BehindTheBuildProps) {
  ...
  const Content = () => (
    <div className="pt-6 space-y-8 pb-2">
      {project.motivation && (
        <div>
          <h5 className="text-[var(--text-xs)] font-bold uppercase tracking-wider text-[var(--color-text-muted)] mb-2">Why I Built This</h5>
      ...
      {project.nextImprovement && (
        <div>
          <h5 className="text-[var(--text-xs)] font-bold uppercase tracking-wider text-[var(--color-text-muted)] mb-2">What I'd Improve Next</h5>
          <p className="text-[var(--text-sm)] text-[var(--color-text-secondary)] leading-relaxed">
            {project.nextImprovement}
          </p>
        </div>
  ...
  if (variant === 'full') {
    return (
      <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-[var(--radius-xl)] p-8 shadow-[var(--shadow-lg)]">
